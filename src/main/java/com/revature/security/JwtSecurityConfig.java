...
//	Setting the order from the order instance. 
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().authorizeRequests().antMatchers("/curriculums/**").authenticated()
	 ...
	 * System.out.println("10"); return new
	 * InMemoryClientRegistrationRepository(this.cognitoClientRegistration()); }
	 * 
	 ...
	 * "phone") .authorizationUri(
	 * "https://bambam-client.auth.us-east-1.amazoncognito.com/oauth2/authorize")
	 * .tokenUri(
	 * "https://bambam-client.auth.us-east-1.amazoncognito.com/oauth2/token")
	 * .userInfoUri(
	 * "https://bambam-client.auth.us-east-1.amazoncognito.com/oauth2/userInfo")
	 * .userNameAttributeName(IdTokenClaimNames.SUB) .jwkSetUri(
	 * "https://cognito-idp.auth.us-east-1.amazonaws.com/_7bWZrc3vS/.well-known/jwks.json")
	 * .clientName("Cognito") .build(); }
	 */
